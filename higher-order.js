...
//Code Here
let evenNumbers = mixedNumbers.filter(element => element % 2 === 0) // = mixedNumbers.filter(/* Provide Your Callback Here */)
...
// let bobsTotal = purchases.reduce((purchaseTotal, element) => {
//     if (element.owner === "Bob") {
//         console.log("elelment: ", element)
//         console.log(purchaseTotal)
//         purchaseTotal += element.price
//     }
// }, 0)

let bobsTotal = purchases.reduce((acc, element) => element.owner === "Bob" ? acc + element.price : acc, 0)
